...
\begin{tikzpicture}[x=10pt,y=6pt]
  ...
  \tikzset{EdgeLabelStyle/.style = {
	...
	\draw[EdgeStyle](B1) to node[EdgeLabelStyle, pos=0.12]{$1$} (C3);
	\draw[EdgeStyle](B2) to node[EdgeLabelStyle]{$0$} (C1);
	\draw[EdgeStyle](B2) to node[EdgeLabelStyle]{$1$} (C3);
	\draw[EdgeStyle](B3) to node[EdgeLabelStyle, pos=0.13]{$0$} (C1);
	\draw[EdgeStyle](B3) to node[EdgeLabelStyle]{$1$} (C3);
	\draw[EdgeStyle](B4) to node[EdgeLabelStyle, pos=0.11]{$0$} (C2);
	\draw[EdgeStyle](B4) to node[EdgeLabelStyle]{$1$} (C4);
	\draw[EdgeStyle](C1) to node[EdgeLabelStyle]{$0$} (D1);
	\draw[EdgeStyle](C1) to node[EdgeLabelStyle, pos=0.12]{$1$} (D3);
	\draw[EdgeStyle](C2) to node[EdgeLabelStyle]{$0$} (D1);
	\draw[EdgeStyle](C2) to node[EdgeLabelStyle]{$1$} (D3);
	\draw[EdgeStyle](C3) to node[EdgeLabelStyle, pos=0.13]{$0$} (D1);
	\draw[EdgeStyle](C3) to node[EdgeLabelStyle]{$1$} (D3);
	\draw[EdgeStyle](C4) to node[EdgeLabelStyle, pos=0.11]{$0$} (D2);
	\draw[EdgeStyle](C4) to node[EdgeLabelStyle]{$1$} (D4);
