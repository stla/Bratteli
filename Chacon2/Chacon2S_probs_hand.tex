...
\begin{tikzpicture}[x=9pt,y=9pt]
  ...
  \tikzset{EdgeLabelStyle/.style = {
	...
	\draw[EdgeStyle](B1) to node[EdgeLabelStyle, pos=0.85]{$\nicefrac{1}{3}$} (C3);
	\draw[EdgeStyle](B2) to node[EdgeLabelStyle]{$\nicefrac{1}{3}$} (C1);
	\draw[EdgeStyle](B2) to node[EdgeLabelStyle]{$\nicefrac{1}{3}$} (C3);
	\draw[EdgeStyle](B3) to node[EdgeLabelStyle]{$\nicefrac{1}{3}$} (C1);
	\draw[EdgeStyle](B3) to node[EdgeLabelStyle]{$\nicefrac{1}{3}$} (C3);
	\draw[EdgeStyle](B4) to node[EdgeLabelStyle, pos=0.86]{$1$} (C2);
	\draw[EdgeStyle](B4) to node[EdgeLabelStyle]{$1$} (C4);
	\draw[EdgeStyle](C1) to node[EdgeLabelStyle]{$\nicefrac{3}{7}$} (D1);
	\draw[EdgeStyle](C1) to node[EdgeLabelStyle, pos=0.85]{$\nicefrac{3}{7}$} (D3);
	\draw[EdgeStyle](C2) to node[EdgeLabelStyle]{$\nicefrac{1}{7}$} (D1);
	\draw[EdgeStyle](C2) to node[EdgeLabelStyle]{$\nicefrac{1}{7}$} (D3);
	\draw[EdgeStyle](C3) to node[EdgeLabelStyle]{$\nicefrac{3}{7}$} (D1);
	\draw[EdgeStyle](C3) to node[EdgeLabelStyle]{$\nicefrac{3}{7}$} (D3);
	\draw[EdgeStyle](C4) to node[EdgeLabelStyle, pos=0.86]{$1$} (D2);
