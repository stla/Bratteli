...
\begin{tikzpicture}[x=10pt,y=6pt]
  ...
  \tikzset{EdgeLabelStyle/.style = {
	...
	\draw[RedEdgeStyle](A1) to node[EdgeLabelStyle]{$\boldone$} (B1);
	\draw[EdgeStyle](A1) to node[EdgeLabelStyle]{$\boldtwo$} (B2);
	\draw[EdgeStyle](B1) to node[EdgeLabelStyle]{$\boldtwo$} (C1);
	\draw[RedEdgeStyle](B1) to node[EdgeLabelStyle]{$\boldone$} (C2);
	\draw[EdgeStyle](B2) to node[EdgeLabelStyle]{$\boldone$} (C3);
	\draw[EdgeStyle](C1) to node[EdgeLabelStyle]{$\boldone$} (D1);
	\draw[EdgeStyle](C2) to node[EdgeLabelStyle]{$\boldone$} (D2);
	\draw[RedEdgeStyle](C2) to node[EdgeLabelStyle]{$\boldtwo$} (D3);
	\draw[EdgeStyle](C3) to node[EdgeLabelStyle]{$\boldone$} (D4);
	\draw[EdgeStyle](C3) to node[EdgeLabelStyle]{$\boldtwo$} (D5);
	\draw[EdgeStyle](D1) to node[EdgeLabelStyle]{$\boldtwo$} (E1);
	\draw[EdgeStyle](D1) to node[EdgeLabelStyle]{$\boldone$} (E2);
	\draw[EdgeStyle](D2) to node[EdgeLabelStyle]{$\boldtwo$} (E3);
	\draw[EdgeStyle](D2) to node[EdgeLabelStyle]{$\boldone$} (E4);
	\draw[RedEdgeStyle](D3) to node[EdgeLabelStyle]{$\boldone$} (E5);
	\draw[EdgeStyle](D4) to node[EdgeLabelStyle]{$\boldtwo$} (E6);
	\draw[EdgeStyle](D4) to node[EdgeLabelStyle]{$\boldone$} (E7);
	\draw[EdgeStyle](D5) to node[EdgeLabelStyle]{$\boldone$} (E8);
