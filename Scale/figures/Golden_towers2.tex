...
\begin{tikzpicture}
  \tikzset{VertexStyle/.style = {shape          = rectangle,
	...
	\draw(a) to node[bblabel={$v_0=\varnothing$}{0pt}, draw=none, fill=none]{} (b) ;
	\node[right=2.7cm of a, label={[blue, inner sep=3pt]above:$\gamma$}, fill=blue](x){};
%% DÉCOUPAGE
	\node[right=1.854102cm of a, label={[gray, inner sep=3pt, xshift=-12pt]above:$1-\theta$}, fill=gray](theta){};
	\node[above=0.5cm of theta, draw=none, fill=none](U){};
	\node[below=0.1cm of theta, draw=none, fill=none](L){};
...
%%% CUTTING STACKING 1 %%%
\node[below=0.5cm of cs0] (cs1) % at ([shift=({-100pt,20pt})]B1)
{
\begin{tikzpicture}
  \tikzset{VertexStyle/.style = {shape          = rectangle,
  								draw, yellow, 
...
%	\tikzset{node distance = 1 cm};
	...
	%
	\draw[draw=red] (b) to node[bblabel={$v_{-1}=2$}{0pt}, draw=none, rectangle, fill=none]{} (c);
...
%    \tikzset{node distance = 1 cm}
	...
	\draw(a) to node[bblabel={$v_{-2}=2$}{0pt}, draw=none, rectangle, fill=none]{} (b);
%	\draw(a) to  (b);
		%%% TOUR DE DROITE %%%
	%
%	\tikzset{node distance = 1 cm};
...
%    \tikzset{node distance = 2 cm}
	\node[blabel={$\theta$}{}](a){};
	\node[right=1.854102cm of a, blabel={$1-\theta$}](b){};
	\draw(a) to node[bblabel={$v_{-3}=1$}{0pt}, draw=none, rectangle, fill=none]{} (b);
%	\draw(a) to (b);
	\tikzset{node distance = 1 cm}
	\node[above=of a](a1){};
	\node[above=of a1](a2){};
	...
	\node[right=of b1](c1){};
	\draw[draw=red](b) to node[bblabel={$v_{-3}=2$}{0pt}, draw=none, rectangle, fill=none]{} (c);
%	\draw[draw=red](b) to  (c);
	\draw(b1) to (c1);
	%%% ORBITE %%%
...
\node[right=0.3cm of cs0, scale=0.8](){$n=0$} ;
\node[right=0.3cm of cs1, scale=0.8](){$n=-1$} ;
\node[right=0.3cm of cs2, scale=0.8](){$n=-2$} ;
\node[right=0.3cm of cs3, scale=0.8](){$n=-3$} ;
