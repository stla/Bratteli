...
\begin{tikzpicture}[x=10pt,y=6pt]
  ...
  \tikzset{EdgeLabelStyle/.style = {
	...
	\node[VertexStyle](C2) at (18.75, 18.75) {$\begin{matrix} a\\ b \end{matrix}$};
	...
	\node[VertexStyle, below=0 of D10](bD10)  {$\begin{matrix} b\\ a\\ a\\ b \end{matrix}$};
