...
\end{align*}
where the last equality come from equality~\eqref{eq:ChaconWord}. 
...
\begin{figure}[!h]
\centering
	\includegraphics[scale=0.8]{figures/GoldenChaconSW_hand}
\caption{$(W_n,\epsilon)$ when $S$ is the golden adic transformation and $T$ is the Chacon transformation}
...
\begin{figure}[!h]
\centering
	\includegraphics[scale=0.8]{figures/OdometerGraphDoubleEdges_hand}
