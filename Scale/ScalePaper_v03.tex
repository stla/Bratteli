...
Later, we will use the following property of the Chacon transformation, which is 
...
As seen in the proof of Proposition~\ref{ppsition:tailfield}, 
...
Let $c$ be the Chacon word defined below \eqref{eq:ChaconWord}. 
Define the weights 
$$
a_{n,k} = \begin{cases}
...
$$ 
Then $S_n(g) \to \int g \mathrm{d}\nu$ in probability. 
xxxx nonxxx $E(g \given {\cal I})$. 
\end{ppsition}
...
The lemma is a generalization of this result, it can be proved by 
