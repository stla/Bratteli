...
\begin{tikzpicture}[x=10pt,y=6pt]
  ...
  \tikzset{EdgeLabelStyle/.style = {
	...
	\draw[EdgeStyle](A1) to node[EdgeLabelStyle]{$XX$} (B1);
	\draw[EdgeStyle](A1) to node[EdgeLabelStyle]{$XX$} (B2);
	\draw[EdgeStyle, bend left=-40](B1) to node[EdgeLabelStyle]{$\nicefrac{1}{4}$} (C1);
	...
	\draw[EdgeStyle, bend left=-40](C1) to node[EdgeLabelStyle]{$\nicefrac{4}{13}$} (D1);
	...
	\draw[EdgeStyle, bend left=-40](D1) to node[EdgeLabelStyle]{$\nicefrac{13}{40}$} (E1);
