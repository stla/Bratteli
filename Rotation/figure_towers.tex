...
%	\draw(a) to node[bblabel={$v_0=1$}{0pt}, draw=none, rectangle, fill=none]{} (b);
	\draw(a) to  (b);
	%%% TOUR DE DROITE %%%
	%
%	\tikzset{node distance = 1 cm};
	...
	%
%	\draw[draw=red] (b) to node[bblabel={$v_0=2$}{0pt}, draw=none, rectangle, fill=none]{} (c);
	\draw[draw=red] (b) to (c);
	\node[left=0.15cm of c, label={[blue, inner sep=3pt]above:$\gamma$}, fill=blue](x){};
%% DÉCOUPAGE
	\node[right=1.145898cm of a, label={[gray, inner sep=3pt, xshift=-5pt]below:$\theta$}, fill=gray](theta){};
...
%	\draw(a) to node[bblabel={$v_1=1$}{0pt}, draw=none, rectangle, fill=none]{} (b);
	\draw(a) to  (b);
		%%% TOUR DE DROITE %%%
	%
%	\tikzset{node distance = 1 cm};
...
%	\draw[draw=red](b) to node[bblabel={$v_1=2$}{0pt}, draw=none, rectangle, fill=none]{} (c);
	\draw[draw=red](b) to (c);
	\draw(b1) to (c1);
	% 
...
%% DÉCOUPAGE
	\node[right=1.854102cm of a, label={[gray, inner sep=3pt, xshift=-6pt]below:$2\theta$}, fill=gray](theta){};
...
%    \tikzset{node distance = 2 cm}
	\node[blabel={$\theta$}{}](a){};
	\node[right=1.854102cm of a, blabel={$1-\theta$}](b){};
%	\draw(a) to node[bblabel={$v_2=1$}{0pt}, draw=none, rectangle, fill=none]{} (b);
	\draw(a) to (b);
	\tikzset{node distance = 1 cm}
	\node[above=of a](a1){};
	\node[above=of a1](a2){};
	...
	\node[right=of b1](c1){};
%	\draw[draw=red](b) to node[bblabel={$v_2=2$}{0pt}, draw=none, rectangle, fill=none]{} (c);
	\draw[draw=red](b) to  (c);
	\draw(b1) to (c1);
	%%% ORBITE %%%
