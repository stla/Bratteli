...
\begin{tikzpicture}[x=7pt,y=5pt]
  ...
  \tikzset{EdgeLabelStyle/.style = {
	...
	\draw[RedEdge](C2) to node[EdgeLabelStyle]{$0$} (D2);
	...
	\draw[RedEdge](D2) to node[EdgeLabelStyle]{$1$} (E3);
